...
public class AgendaViewController implements Initializable 
{
    ...
    private void OnActionButtonGuardar(ActionEvent event) 
    {
        if (personaSeleccionada != null)
        {
            // Actualiza los valoras Nombre y Apellidos del objeto Persona asignándole los valores
            ...
            // Obtiene el número de la fila seleccionada y asigna el nuevo objeto a esa fila
            ...
            // Devuelve el foco al TableView para que el usuario pueda seguir moviéndose por su contenido
    ...
    {
        // Mostrará una alerta en el caso de que el usuario quiera suprimir  un registro
        // Dicha alerta mostrará el nombre y el apellido de la persona a suprimir
