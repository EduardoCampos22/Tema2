...
public class PersonaDetalleViewController implements Initializable 
{
    ...
    private void onActionButtonGuardar(ActionEvent event) 
    {
        ...
        // Actualiza los nuevos datos en el TableView. Si se trata de una nueva persona, selecciona la última fila.
        // Si la persona ya existía se volverá a seleccionar la línea en la que se encontraba.
    ...
    private void onActionButtonCancelar(ActionEvent event) 
    {
        ...
        // Anula la transacción que se había empezado en el código del método setPersona
    ...
    public void mostrarDatos()
    {
        ...
        textFieldTelefono.setText(persona.getTelefono());       // Nº de telefono de la persona
        textFieldEmail.setText(persona.getEmail());             // eMail de la persona
        
        
        // Nº de Hijos de la persona
        ...
        // Si el objeto Persona tiene asignada una Provincia, esta se mostrará directamente en el ComboBox
        if (persona.getProvincia() != null)        
            comboBoxProvincia.setValue(persona.getProvincia());         
        
        // Mostrará en la lista de objetos del ComboBox el código y el nombre de la provincia                
